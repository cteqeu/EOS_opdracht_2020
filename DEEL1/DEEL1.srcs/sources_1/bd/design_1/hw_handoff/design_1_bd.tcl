...
proc create_root_design { parentCell } {
  ...
  set DOWN_BUTTON [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 DOWN_BUTTON ]

  set FIXED_IO_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_processing_system7:fixedio_rtl:1.0 FIXED_IO_0 ]

  set UP_BUTTON [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 UP_BUTTON ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports UP_BUTTON] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports DOWN_BUTTON] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins MatrixEncoder_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net MatrixEncoder_0_ds [get_bd_ports ds_0] [get_bd_pins MatrixEncoder_0/ds]
  connect_bd_net -net MatrixEncoder_0_sh_cp [get_bd_ports sh_cp_0] [get_bd_pins MatrixEncoder_0/sh_cp]
  connect_bd_net -net MatrixEncoder_0_st_cp [get_bd_ports st_cp_0] [get_bd_pins MatrixEncoder_0/st_cp]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins MatrixEncoder_0/clk_10Mhz] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins MatrixEncoder_0/reset] [get_bd_pins clk_wiz_0/locked]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins MatrixEncoder_0/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins MatrixEncoder_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MatrixEncoder_0/S00_AXI/S00_AXI_reg] -force
